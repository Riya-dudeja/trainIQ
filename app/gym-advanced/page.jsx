    ...
    loadScripts().then(() => {
      ...
      poseInstance.onResults(async (results) => {
        ...
        if (results.poseLandmarks) {
          ...
          setIsAnalyzing(true);
          try {
            const analysis = await gymFitAPI.analyzePose(poseData, selectedPose);
            ...
            const localAnalysis = gymFitAPI.localPoseAnalysis(poseData, selectedPose);
            setPoseScore(localAnalysis.score || 0);
            setFeedback(localAnalysis.feedback || []);
          }
